function runExplanationAccessManagerTests(failureChecker) {
    ...
    {
        // ok to show any tree prior to latest complete controlled tree showing
        ...
        m.hopToDP(5);        fc.assert(m.showUnlockControls,false,"f1");  fc.assert(m.showExplButtonEnabled,false,"f2");
        m.pauseAtDP(6);      fc.assert(m.showUnlockControls,false,"g1");  fc.assert(m.showExplButtonEnabled,false,"g2");
        m.hopToDP(6);        fc.assert(m.showUnlockControls,false,"h1");  fc.assert(m.showExplButtonEnabled,false,"h2");
        m.pauseAfterDP(6);   fc.assert(m.showUnlockControls,false,"h1a");  fc.assert(m.showExplButtonEnabled,false,"h2a");
        m.hopToAfterDP(6);   fc.assert(m.showUnlockControls,false,"h1b");  fc.assert(m.showExplButtonEnabled,false,"h2b");       
    ...
    }
    {
        ...
        // hop back and verify nothing changed (need to move PAST the controlled showing)
        m.hopToDP(5);         fc.assert(m.showUnlockControls,false,"f1");  fc.assert(m.showExplButtonEnabled,false,"f2");
        m.hopToDP(6);         fc.assert(m.showUnlockControls,false,"g1");  fc.assert(m.showExplButtonEnabled,false,"g2");
        m.hopToDP(6);         fc.assert(m.showUnlockControls,false,"h1");  fc.assert(m.showExplButtonEnabled,false,"h2");
        m.pauseAfterDP(6);   fc.assert(m.showUnlockControls,false,"h1a");  fc.assert(m.showExplButtonEnabled,false,"h2a");
        ...
        m.hopToDP(9);         fc.assert(m.showUnlockControls,false,"v1");  fc.assert(m.showExplButtonEnabled,false,"v2");
        m.hopToDP(11);        fc.assert(m.showUnlockControls,false,"w1");  fc.assert(m.showExplButtonEnabled,false,"w2");

        m.hopToDP(12);       fc.assert(m.showUnlockControls,false,"u1");  fc.assert(m.showExplButtonEnabled,true,"x2");
        m.resume();
        m.hopToDP(9);         fc.assert(m.showUnlockControls,false,"v1");  fc.assert(m.showExplButtonEnabled,true,"y2");
        m.hopToDP(11);        fc.assert(m.showUnlockControls,false,"w1");  fc.assert(m.showExplButtonEnabled,true,"z2");
    }
}